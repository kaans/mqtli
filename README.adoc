...
Filters can optionally be applied to messages received on a subscribed topic. They allow additional processing of the
...
| ignore_non_json
| If true, input data which is not JSON will be ignored; if false, an error is thrown and further processing is stopped.
| boolean
| false
|==================================================================================================================================================================
...
| ignore_non_text
| If true, input data which is not Text will be ignored; if false, an error is thrown and further processing is stopped.
| boolean
| false
|==================================================================================================================================================================
